<!-- Hero Section -->
<section class="bg-gradient-to-br from-primary-50 via-white to-white">
    <div class="max-w-6xl mx-auto px-6 py-24 lg:py-32">
        <div class="max-w-3xl">
            <p class="text-primary-700 font-bold uppercase tracking-widest text-xs mb-4">Welcome</p>
            <h1 class="text-5xl lg:text-6xl font-black text-gray-900 leading-tight">
                Build Something <span class="text-primary-700">Amazing</span>
            </h1>
            ...
            <div class="mt-10 flex flex-wrap gap-4">
                <a href="<?= BASE_URL ?>/about" class="inline-flex items-center gap-2 bg-primary hover:bg-primary-800 text-white font-bold px-8 py-4 rounded-xl shadow-lg shadow-primary/20 transition-all hover:-translate-y-0.5">
                    Get Started &rarr;
                </a>
    ...
    <div class="max-w-6xl mx-auto px-6">
        ...
        <div class="mt-12 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div class="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg transition">
                <div class="w-12 h-12 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center text-xl font-bold">1</div>
            ...
            <div class="bg-white p-8 rounded-2xl border border-gray-200 shadow-sm hover:shadow-lg transition">
                <div class="w-12 h-12 rounded-xl bg-primary-100 text-primary-700 flex items-center justify-center text-xl font-bold">3</div>
