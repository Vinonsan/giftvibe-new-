...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
            <h1 class="text-xl font-bold text-secondary">Combos</h1>
            <p class="mt-1 text-sm text-slate-500">Create and manage gift combos using existing products.</p>
        </div>
        <button
            type="button"
            data-drawer-open="combo-drawer"
...
<?php
$deleteModalId    = 'combo-delete-modal';
$deleteFormAction = '/admin/combos';
$deleteItemLabel  = 'combo';
