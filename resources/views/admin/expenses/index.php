...
<div class="space-y-5">
 ...
 <div class="grid gap-4 sm:grid-cols-2">
  <div class="rounded-2xl border border-emerald-100 bg-emerald-50/40 p-5 shadow-sm"><p class="text-[10px] font-bold uppercase tracking-wider text-emerald-700">Cash on hand</p><p class="mt-2 text-2xl font-black text-emerald-700">LKR <?= number_format((float)$cashOnHand,2) ?></p><p class="mt-1 text-xs text-emerald-700/70">For business and order-related expenses</p></div>
  <div class="rounded-2xl border border-primary/15 bg-primary/5 p-5 shadow-sm"><p class="text-[10px] font-bold uppercase tracking-wider text-primary">Available profit</p><p class="mt-2 text-2xl font-black text-primary">LKR <?= number_format((float)$availableProfit,2) ?></p><p class="mt-1 text-xs text-primary/70">Personal withdrawals cannot exceed this balance</p></div>
 </div>
