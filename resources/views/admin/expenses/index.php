...
<div class="space-y-5">
    ...
    <div class="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:flex-row sm:items-center sm:justify-between">
        <div>
            ...
            <p class="mt-1 text-sm text-slate-500">Product stock, packing, delivery and other business costs. These reduce cash on hand and net profit on the dashboard.</p>
        </div>
