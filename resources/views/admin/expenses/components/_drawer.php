...
document.addEventListener('DOMContentLoaded',function(){
 var meta={},form=document.getElementById('expense-form'),view=document.getElementById('expense-view'),usable=<?= json_encode((float)$usableCash) ?>,profit=<?= json_encode((float)$availableProfit) ?>;
 ...
 function sync(source){var isProfit=source==='profit',toggle=document.getElementById('expense-profit-toggle');document.getElementById('expense-paid-source').value=isProfit?'profit':'company_cash';if(toggle)toggle.checked=isProfit;document.getElementById('expense-source-help').textContent=isProfit?'Available profit: '+money(profit):'Usable cash: '+money(usable);}
