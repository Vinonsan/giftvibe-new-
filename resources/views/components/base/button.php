...
$buttonPalette = [
    'primary' => [
        ...
        'link'    => 'bg-transparent p-0 text-primary underline-offset-4 hover:underline focus-visible:ring-primary/30',
    ],
    'secondary' => [
        ...
        'link'    => 'bg-transparent p-0 text-secondary underline-offset-4 hover:underline focus-visible:ring-secondary/30',
    ],
    'accent' => [
        ...
        'link'    => 'bg-transparent p-0 text-accent underline-offset-4 hover:underline focus-visible:ring-accent/30',
    ],
    'success' => [
        ...
        'link'    => 'bg-transparent p-0 text-emerald-700 underline-offset-4 hover:underline focus-visible:ring-emerald-500/30',
    ],
    'warning' => [
        ...
        'link'    => 'bg-transparent p-0 text-amber-600 underline-offset-4 hover:underline focus-visible:ring-amber-500/30',
    ],
    'danger' => [
        ...
        'link'    => 'bg-transparent p-0 text-rose-600 underline-offset-4 hover:underline focus-visible:ring-rose-500/30',
    ],
];
...
$buttonBase = 'inline-flex select-none items-center justify-center gap-2 rounded-lg font-semibold transition focus:outline-none focus-visible:ring-2 disabled:pointer-events-none disabled:opacity-60';
