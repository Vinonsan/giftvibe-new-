...
<section class="mx-auto max-w-7xl py-12 sm:py-16">
    ...
    <div class="mt-12 grid gap-5 md:grid-cols-2 lg:grid-cols-3">
        ...
        <article class="rounded-3xl border border-slate-200 bg-white p-7 shadow-sm"><h2 class="text-xl font-extrabold text-secondary"><?=htmlspecialchars($heading)?></h2><p class="mt-3 text-sm leading-7 text-slate-600"><?=htmlspecialchars($copy)?></p></article>
        <?php endforeach; ?>
    </div>
