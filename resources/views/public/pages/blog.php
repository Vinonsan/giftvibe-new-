...
<section class="mx-auto max-w-7xl py-12 sm:py-16">
    ...
    <div class="mt-12 grid gap-6 md:grid-cols-3">
        ...
        <article class="flex flex-col rounded-3xl border border-primary/10 bg-white p-7 shadow-sm"><p class="text-xs font-bold uppercase tracking-wider text-primary"><?=htmlspecialchars($category)?></p><h2 class="mt-3 text-xl font-extrabold leading-tight text-secondary"><?=htmlspecialchars($heading)?></h2><p class="mt-4 text-sm leading-7 text-slate-600"><?=htmlspecialchars($copy)?></p><a href="/shop" class="mt-6 text-sm font-bold text-primary">Explore related gifts &rarr;</a></article>
        <?php endforeach; ?>
    </div>
